          ...
          <ul class="navbar-nav ml-auto">
            ...
            @endphp
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in">
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{route('commentreport',$item->event_id)}}">
                  <div class="mr-3">
                  ...
                  <div>
                    <div class="small text-gray-500">{{$item->event['event-date']}}</div>
                    <span class="font-weight-bold">{{$item->event->location}}</span>
                  </div>
                </a>
                @else
                @endif
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{Auth::user()->department->name}}</span>
...
<tr class="bg-blue">
    <td class="pt-2">
    <div class="pl-lg-5 pl-md-3 pl-1 name">{{$event->event->location}}</div>
    </td>
    <td class="pt-3 mt-1">{{$event->event['event-date']}}</td>
    <td class="pt-3">{{date("H:i",strtotime($event->event['event-date']))}}</td>
    <td class="pt-3"><span class="fa fa-check pl-3"></span></td>
    <td class="pt-3">  <a href="{{route('finalManagmnetReport',$event->event_id)}}" <span class="fa fa-ellipsis-v btn"></span></a></td>
    </tr>
  ...
  // console.log("count");
   ...
   console.log(count);
    ...
    $(".notification").prepend(` <a class="dropdown-item d-flex align-items-center"
                                href="/commentreport/${data.event.id}">
                                <div class="mr-3">
                                    <div class="icon-circle">
                                        <i class="fa fa-file"></i>
                                    </div>

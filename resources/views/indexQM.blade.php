          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Quality Manager</span>
                <img class="img-profile rounded-circle" src="img/avatar.jpg">
              </a>

              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="signup.html" data-toggle="modal" data-target="#logoutModal">
...
<td class="pt-3"> <a href="{{ route('riskmanager.final_report', $event->id) }}" <span
    class="fa fa-ellipsis-v btn"></span></a></td></tr>
<tr id="spacing-row">
<td></td>
</tr>
